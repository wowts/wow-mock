...
export declare function GetMacroItem(spellId: number): never[];
export declare function GetMacroSpell(spellId: number): never[];
export declare function GetSpellInfo(spellId: number | string, bookType?: number): never[];
export declare function GetTime(): number;
export declare function InterfaceOptionsFrame_OpenToCategory(frameName: string): void;
export declare function UnitAura(unitId: string, i: number, filter: string): never[];
...
export declare function GetSpellCharges(spellId: number): never[];
...
export declare function GetFlyoutInfo(flyoutId: number): never[];
export declare function GetFlyoutSlotInfo(flyoutId: number, flyoutIndex: number): never[];
export declare function GetSpellBookItemInfo(index: number | string, bookType?: string): never[];
...
export declare function GetSpellTabInfo(tab: number): never[];
export declare function GetTalentInfo(i: number, j: number, activeTalentGroup: number): never[];
...
export declare function IsUsableSpell(index: number | string, bookType?: string): never[];
export declare function GetNumShapeshiftForms(): number;
export declare function GetShapeshiftForm(): void;
export declare function GetShapeshiftFormInfo(index: number): never[];
export declare function GetTotemInfo(slot: number): never[];
