...
export const C_GossipInfo = {
    ...
    SelectOption: (index: number, text: string | undefined, confirmed: boolean | undefined): void => {},
};
export type DynamicGossipPoiUpdatedEvent = (frame: UIFrame, e: "DYNAMIC_GOSSIP_POI_UPDATED") => void
export type GossipClosedEvent = (frame: UIFrame, e: "GOSSIP_CLOSED") => void
export type GossipConfirmEvent = (frame: UIFrame, e: "GOSSIP_CONFIRM", gossipIndex: number, text: string, cost: number) => void
export type GossipConfirmCancelEvent = (frame: UIFrame, e: "GOSSIP_CONFIRM_CANCEL") => void
export type GossipEnterCodeEvent = (frame: UIFrame, e: "GOSSIP_ENTER_CODE", gossipIndex: number) => void
export type GossipOptionsRefreshedEvent = (frame: UIFrame, e: "GOSSIP_OPTIONS_REFRESHED") => void
export type GossipShowEvent = (frame: UIFrame, e: "GOSSIP_SHOW", uiTextureKit: string | undefined) => void