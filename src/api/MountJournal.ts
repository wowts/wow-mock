...
export const C_MountJournal = {
    ...
    GetDisplayedMountAllCreatureDisplayInfo: (mountIndex: number): any => {return {} as any},
    ...
    GetMountAllCreatureDisplayInfoByID: (mountID: number): any => {return {} as any},
