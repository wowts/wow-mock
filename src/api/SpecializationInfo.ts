...
export type ActiveTalentGroupChangedEvent = (frame: UIFrame, e: "ACTIVE_TALENT_GROUP_CHANGED", curr: number, prev: number) => void
export type ConfirmTalentWipeEvent = (frame: UIFrame, e: "CONFIRM_TALENT_WIPE", cost: number, respecType: number) => void
export type PetSpecializationChangedEvent = (frame: UIFrame, e: "PET_SPECIALIZATION_CHANGED") => void
export type PlayerLearnPvpTalentFailedEvent = (frame: UIFrame, e: "PLAYER_LEARN_PVP_TALENT_FAILED") => void
export type PlayerLearnTalentFailedEvent = (frame: UIFrame, e: "PLAYER_LEARN_TALENT_FAILED") => void
export type PlayerPvpTalentUpdateEvent = (frame: UIFrame, e: "PLAYER_PVP_TALENT_UPDATE") => void
export type PlayerTalentUpdateEvent = (frame: UIFrame, e: "PLAYER_TALENT_UPDATE") => void
export type SpecInvoluntarilyChangedEvent = (frame: UIFrame, e: "SPEC_INVOLUNTARILY_CHANGED", isPet: boolean) => void
export type TalentsInvoluntarilyResetEvent = (frame: UIFrame, e: "TALENTS_INVOLUNTARILY_RESET", isPetTalents: boolean) => void