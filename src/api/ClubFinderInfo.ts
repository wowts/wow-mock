...
export const C_ClubFinder = {
    ...
    DoesPlayerBelongToClubFromClubGUID: (clubFinderGUID: string): boolean => {return false},
    GetClubFinderDisableReason: (): ClubFinderDisableReason | undefined => {return ClubFinderDisableReason.Muted},
    GetClubRecruitmentSettings: (): ClubSettingsInfo => {return {playStyleDungeon: false, playStyleRaids: false, playStylePvp: false, playStyleRP: false, playStyleSocial: false, roleTank: false, roleHealer: false, roleDps: false, sizeSmall: false, sizeMedium: false, sizeLarge: false, maxLevelOnly: false, enableListing: false, sortRelevance: false, sortMembers: false, sortNewest: false, autoAccept: false}},
    GetClubTypeFromFinderGUID: (clubFinderGUID: string): ClubFinderRequestType => {return ClubFinderRequestType.None},
    GetFocusIndexFromFlag: (flags: number): number => {return 0},
    GetPlayerApplicantLocaleFlags: (): number => {return 0},
    GetPlayerApplicantSettings: (): ClubSettingsInfo => {return {playStyleDungeon: false, playStyleRaids: false, playStylePvp: false, playStyleRP: false, playStyleSocial: false, roleTank: false, roleHealer: false, roleDps: false, sizeSmall: false, sizeMedium: false, sizeLarge: false, maxLevelOnly: false, enableListing: false, sortRelevance: false, sortMembers: false, sortNewest: false, autoAccept: false}},
    GetPlayerClubApplicationStatus: (clubFinderGUID: string): PlayerClubRequestStatus => {return PlayerClubRequestStatus.None},
    GetPlayerSettingsFocusFlagsSelectedCount: (): number => {return 0},
    ...
    HasPostingBeenDelisted: (postingID: string): boolean => {return false},
...
export type ClubFinderEnabledOrDisabledEvent = (frame: UIFrame, e: "CLUB_FINDER_ENABLED_OR_DISABLED") => void
