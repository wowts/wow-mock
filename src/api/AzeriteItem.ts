...
export const C_AzeriteItem = {
    FindActiveAzeriteItem: (): ItemLocationMixin => {return {} as any},
    GetAzeriteItemXPInfo: (azeriteItemLocation: ItemLocationMixin): [xp: number, totalLevelXP: number] => {return [0, 0]},
    GetPowerLevel: (azeriteItemLocation: ItemLocationMixin): number => {return 0},
    GetUnlimitedPowerLevel: (azeriteItemLocation: ItemLocationMixin): number => {return 0},
    HasActiveAzeriteItem: (): boolean => {return false},
    IsAzeriteItem: (itemLocation: ItemLocationMixin): boolean => {return false},
    IsAzeriteItemAtMaxLevel: (): boolean => {return false},
    IsAzeriteItemByID: (itemInfo: string): boolean => {return false},
    IsAzeriteItemEnabled: (azeriteItemLocation: ItemLocationMixin): boolean => {return false},
};
