...
export const C_Club = {
    ...
    CreateTicket: (
        clubId: string,
        allowedRedeemCount: number | undefined,
    ...
    EditStream: (
        ...
        leadersAndModeratorsOnly: boolean | undefined
    ): void => {},
    Flush: (): void => {},
    FocusStream: (clubId: string, streamId: string): boolean => {
        return false;
    },
    GetAssignableRoles: (
        clubId: string,
        memberId: number
    ): LuaArray<ClubRoleIdentifier> => {
        return {} as any;
    },
    GetAvatarIdList: (clubType: ClubType): LuaArray<number> | undefined => {
        return {} as any;
    },
    GetClubCapacity: (): number => {
        return 0;
    },
    GetClubInfo: (clubId: string): ClubInfo | undefined => {
        return {
            clubId: "",
            name: "",
            shortName: "",
            description: "",
            broadcast: "",
            clubType: ClubType.BattleNet,
            avatarId: 0,
            memberCount: 0,
            favoriteTimeStamp: 0,
            joinTime: 0,
            socialQueueingEnabled: false,
        };
    },
    GetClubLimits: (clubType: ClubType): ClubLimits => {
    ...
    GetClubPrivileges: (clubId: string): ClubPrivilegeInfo => {
        return {
            canDestroy: false,
            ...
            canSetAvatar: false,
            canSetBroadcast: false,
            canSetPrivacyLevel: false,
            canSetOwnMemberAttribute: false,
            canSetOtherMemberAttribute: false,
            canSetOwnMemberNote: false,
            canSetOtherMemberNote: false,
            canSetOwnVoiceState: false,
            canSetOwnPresenceLevel: false,
            canUseVoice: false,
            canVoiceMuteMemberForAll: false,
            canGetInvitation: false,
            canSendInvitation: false,
            canSendGuestInvitation: false,
            canRevokeOwnInvitation: false,
            canRevokeOtherInvitation: false,
            canGetBan: false,
            canGetSuggestion: false,
            canSuggestMember: false,
            canGetTicket: false,
            canCreateTicket: false,
            canDestroyTicket: false,
            canAddBan: false,
            canRemoveBan: false,
            canCreateStream: false,
            canDestroyStream: false,
            canSetStreamPosition: false,
            canSetStreamAttribute: false,
            canSetStreamName: false,
            canSetStreamSubject: false,
            canSetStreamAccess: false,
            canSetStreamVoiceLevel: false,
            canCreateMessage: false,
            canDestroyOwnMessage: false,
            canDestroyOtherMessage: false,
    ...
    GetClubStreamNotificationSettings: (
        clubId: string
    ): LuaArray<ClubStreamNotificationSetting> => {
        return {} as any;
    },
    GetCommunityNameResultText: (
        result: ValidateNameResult
    ): string | undefined => {
        return "";
    },
    GetGuildClubId: (): string | undefined => {
        return "";
    },
    GetInfoFromLastCommunityChatLine: (): [
        messageInfo: ClubMessageInfo,
        clubId: string,
        streamId: string,
        clubType: ClubType
    ] => {
        return [
            {
                messageId: { epoch: 0, position: 0 },
                content: "",
                author: {
                    isSelf: false,
                    memberId: 0,
                    name: "",
                    role: ClubRoleIdentifier.Owner,
                    presence: ClubMemberPresence.Unknown,
                    clubType: ClubType.BattleNet,
                    guid: "",
                    bnetAccountId: 0,
                    memberNote: "",
    ...
    GetInvitationCandidates: (
        ...
        clubId: string
    ): LuaArray<ClubInvitationCandidateInfo> => {
        return {} as any;
    },
    GetInvitationInfo: (clubId: string): ClubSelfInvitationInfo | undefined => {
        return {
            invitationId: "",
            club: {
                clubId: "",
    ...
    GetInvitationsForClub: (clubId: string): LuaArray<ClubInvitationInfo> => {
        return {} as any;
    },
    GetInvitationsForSelf: (): LuaArray<ClubSelfInvitationInfo> => {
        return {} as any;
    },
    GetLastTicketResponse: (
        ...
        error: ClubErrorType,
        info: ClubInfo | undefined,
        showError: boolean
    ] => {
        return [
            ClubErrorType.ErrorCommunitiesNone,
            {
                clubId: "",
                name: "",
                shortName: "",
    ...
    GetStreamInfo: (
        ...
        return {
            ...
            name: "",
            subject: "",
            leadersAndModeratorsOnly: false,
            streamType: ClubStreamType.General,
            creationTime: 0,
        };
    },
    GetStreamViewMarker: (
    ...
    GetStreams: (clubId: string): LuaArray<ClubStreamInfo> => {
        return {} as any;
    },
    GetSubscribedClubs: (): LuaArray<ClubInfo> => {
        return {} as any;
    },
    GetTickets: (clubId: string): LuaArray<ClubTicketInfo> => {
        return {} as any;
    },
    IsAccountMuted: (clubId: string): boolean => {
        return false;
    },
    IsBeginningOfStream: (
        clubId: string,
    ...
    IsRestricted: (): ClubRestrictionReason => {
        return ClubRestrictionReason.None;
    },
    IsSubscribedToStream: (clubId: string, streamId: string): boolean => {
        return false;
    },
    ...
    RequestMoreMessagesBefore: (
        clubId: string,
        streamId: string,
        messageId: ClubMessageIdentifier | undefined,
    ...
    ValidateText: (
        ...
        return ValidateNameResult.NameSuccess;
    },
};
export type AvatarListUpdatedEvent = (
    frame: UIFrame,
    e: "AVATAR_LIST_UPDATED",
    clubType: ClubType
) => void;
export type ClubAddedEvent = (
    frame: UIFrame,
    e: "CLUB_ADDED",
    clubId: string
) => void;
export type ClubErrorEvent = (
    frame: UIFrame,
    e: "CLUB_ERROR",
...
export type ClubInvitationAddedForSelfEvent = (
    frame: UIFrame,
    e: "CLUB_INVITATION_ADDED_FOR_SELF",
    invitation: ClubSelfInvitationInfo
) => void;
export type ClubInvitationRemovedForSelfEvent = (
    frame: UIFrame,
    e: "CLUB_INVITATION_REMOVED_FOR_SELF",
    invitationId: string
) => void;
export type ClubInvitationsReceivedForClubEvent = (
    frame: UIFrame,
    e: "CLUB_INVITATIONS_RECEIVED_FOR_CLUB",
    clubId: string
) => void;
export type ClubMemberAddedEvent = (
    frame: UIFrame,
    e: "CLUB_MEMBER_ADDED",
    clubId: string,
    memberId: number
) => void;
export type ClubMemberPresenceUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_MEMBER_PRESENCE_UPDATED",
    clubId: string,
    memberId: number,
    presence: ClubMemberPresence
) => void;
export type ClubMemberRemovedEvent = (
    frame: UIFrame,
    e: "CLUB_MEMBER_REMOVED",
    clubId: string,
    memberId: number
) => void;
export type ClubMemberRoleUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_MEMBER_ROLE_UPDATED",
    clubId: string,
    memberId: number,
    roleId: number
) => void;
export type ClubMemberUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_MEMBER_UPDATED",
    clubId: string,
    memberId: number
) => void;
export type ClubMessageAddedEvent = (
    frame: UIFrame,
    e: "CLUB_MESSAGE_ADDED",
    clubId: string,
    streamId: string,
    messageId: ClubMessageIdentifier
) => void;
export type ClubMessageHistoryReceivedEvent = (
    frame: UIFrame,
    e: "CLUB_MESSAGE_HISTORY_RECEIVED",
    clubId: string,
    streamId: string,
    downloadedRange: ClubMessageRange,
    contiguousRange: ClubMessageRange
) => void;
export type ClubMessageUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_MESSAGE_UPDATED",
    clubId: string,
    streamId: string,
    messageId: ClubMessageIdentifier
) => void;
export type ClubRemovedEvent = (
    frame: UIFrame,
    e: "CLUB_REMOVED",
    clubId: string
) => void;
export type ClubRemovedMessageEvent = (
    frame: UIFrame,
    e: "CLUB_REMOVED_MESSAGE",
    clubName: string,
    clubRemovedReason: ClubRemovedReason
) => void;
export type ClubSelfMemberRoleUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_SELF_MEMBER_ROLE_UPDATED",
    clubId: string,
    roleId: number
) => void;
export type ClubStreamAddedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAM_ADDED",
    clubId: string,
    streamId: string
) => void;
export type ClubStreamRemovedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAM_REMOVED",
    clubId: string,
    streamId: string
) => void;
export type ClubStreamSubscribedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAM_SUBSCRIBED",
    clubId: string,
    streamId: string
) => void;
export type ClubStreamUnsubscribedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAM_UNSUBSCRIBED",
    clubId: string,
    streamId: string
) => void;
export type ClubStreamUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAM_UPDATED",
    clubId: string,
    streamId: string
) => void;
export type ClubStreamsLoadedEvent = (
    frame: UIFrame,
    e: "CLUB_STREAMS_LOADED",
    clubId: string
) => void;
export type ClubTicketCreatedEvent = (
    frame: UIFrame,
    e: "CLUB_TICKET_CREATED",
    clubId: string,
    ticketInfo: ClubTicketInfo
) => void;
export type ClubTicketReceivedEvent = (
    frame: UIFrame,
    e: "CLUB_TICKET_RECEIVED",
    ticket: string
) => void;
export type ClubTicketsReceivedEvent = (
    frame: UIFrame,
    e: "CLUB_TICKETS_RECEIVED",
    clubId: string
) => void;
export type ClubUpdatedEvent = (
    frame: UIFrame,
    e: "CLUB_UPDATED",
    clubId: string
) => void;
export type InitialClubsLoadedEvent = (
    frame: UIFrame,
    e: "INITIAL_CLUBS_LOADED"
) => void;
export type StreamViewMarkerUpdatedEvent = (
    frame: UIFrame,
    e: "STREAM_VIEW_MARKER_UPDATED",
    clubId: string,
    streamId: string,
