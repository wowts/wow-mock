...
export const C_RecruitAFriend = {
    ClaimActivityReward: (activityID: number, acceptanceID: string): boolean => {return false},
    ClaimNextReward: (): boolean => {return false},
    ...
    RemoveRAFRecruit: (wowAccountGUID: string): boolean => {return false},
    RequestUpdatedRecruitmentInfo: (): boolean => {return false},
};
export type RafInfoUpdatedEvent = (frame: UIFrame, e: "RAF_INFO_UPDATED", info: RafInfo) => void
export type RafRecruitingEnabledStatusEvent = (frame: UIFrame, e: "RAF_RECRUITING_ENABLED_STATUS", enabled: boolean) => void
export type RafSystemEnabledStatusEvent = (frame: UIFrame, e: "RAF_SYSTEM_ENABLED_STATUS", enabled: boolean) => void
export type RafSystemInfoUpdatedEvent = (frame: UIFrame, e: "RAF_SYSTEM_INFO_UPDATED", systemInfo: RafSystemInfo) => void