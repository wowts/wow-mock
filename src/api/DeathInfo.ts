...
export type AreaSpiritHealerOutOfRangeEvent = (frame: UIFrame, e: "AREA_SPIRIT_HEALER_OUT_OF_RANGE") => void
export type CemeteryPreferenceUpdatedEvent = (frame: UIFrame, e: "CEMETERY_PREFERENCE_UPDATED") => void
export type ConfirmXpLossEvent = (frame: UIFrame, e: "CONFIRM_XP_LOSS") => void
export type CorpseInInstanceEvent = (frame: UIFrame, e: "CORPSE_IN_INSTANCE") => void
export type CorpseInRangeEvent = (frame: UIFrame, e: "CORPSE_IN_RANGE") => void
export type CorpseOutOfRangeEvent = (frame: UIFrame, e: "CORPSE_OUT_OF_RANGE") => void
...
export type PlayerSkinnedEvent = (frame: UIFrame, e: "PLAYER_SKINNED", hasFreeRepop: number) => void
export type PlayerUnghostEvent = (frame: UIFrame, e: "PLAYER_UNGHOST") => void
export type RequestCemeteryListResponseEvent = (frame: UIFrame, e: "REQUEST_CEMETERY_LIST_RESPONSE", isGossipTriggered: boolean) => void
export type ResurrectRequestEvent = (frame: UIFrame, e: "RESURRECT_REQUEST", inviter: string) => void
export type SelfResSpellChangedEvent = (frame: UIFrame, e: "SELF_RES_SPELL_CHANGED") => void