...
export type MythicPlusCurrentAffixUpdateEvent = (frame: UIFrame, e: "MYTHIC_PLUS_CURRENT_AFFIX_UPDATE") => void
export type MythicPlusNewSeasonRecordEvent = (frame: UIFrame, e: "MYTHIC_PLUS_NEW_SEASON_RECORD", mapChallengeModeID: number, completionMilliseconds: number, level: number) => void
export type MythicPlusNewWeeklyRecordEvent = (frame: UIFrame, e: "MYTHIC_PLUS_NEW_WEEKLY_RECORD", mapChallengeModeID: number, completionMilliseconds: number, level: number) => void