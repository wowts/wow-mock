import { RuneforgeLegendaryCraftDescription, ItemLocationMixin, RuneforgeItemPreviewInfo, RuneforgeLegendaryComponentInfo, RuneforgePower } from '../mixins';
...
export const C_LegendaryCrafting = {
    ...
    GetRuneforgeItemPreviewInfo: (baseItem: ItemLocationMixin, runeforgePowerID: number | undefined, modifiers: any | undefined): RuneforgeItemPreviewInfo | undefined => {return {} as any},
    GetRuneforgeLegendaryComponentInfo: (runeforgeLegendary: ItemLocationMixin): RuneforgeLegendaryComponentInfo => {return {} as any},
    GetRuneforgeLegendaryCost: (baseItem: ItemLocationMixin): any => {return {} as any},
    GetRuneforgeLegendaryCraftSpellID: (): number => {return 0},
    GetRuneforgeLegendaryCurrencies: (): any => {return {} as any},
    GetRuneforgeLegendaryUpgradeCost: (runeforgeLegendary: ItemLocationMixin, upgradeItem: ItemLocationMixin): any => {return {} as any},
    GetRuneforgeModifierInfo: (baseItem: ItemLocationMixin, powerID: number | undefined, addedModifierIndex: number, modifiers: any): [name: string, description: string] => {return ['', '']},
    GetRuneforgeModifiers: (): any => {return {} as any},
    GetRuneforgePowerInfo: (runeforgePowerID: number): RuneforgePower => {return {} as any},
    GetRuneforgePowerSlots: (runeforgePowerID: number): any => {return {} as any},
    GetRuneforgePowers: (baseItem: ItemLocationMixin | undefined): any => {return {} as any},
    GetRuneforgePowersByClassAndSpec: (classID: number | undefined, specID: number | undefined): any => {return {} as any},
    ...
    MakeRuneforgeCraftDescription: (baseItem: ItemLocationMixin, runeforgePowerID: number, modifiers: any): RuneforgeLegendaryCraftDescription => {return {} as any},
