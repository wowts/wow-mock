...
export const C_TaskQuest = {
    DoesMapShowTaskQuestObjectives: (uiMapID: number): boolean => {
        return false;
    },
    GetQuestInfoByQuestID: (
        ...
        displayAsObjective: boolean | undefined
    ] => {
    ...
    GetQuestProgressBarInfo: (questID: number): number => {
        return 0;
    },
    GetQuestTimeLeftMinutes: (questID: number): number => {
        return 0;
    },
    GetQuestTimeLeftSeconds: (questID: number): number => {
        return 0;
    },
    GetQuestZoneID: (questID: number): number => {
        return 0;
    },
    GetQuestsForPlayerByMapID: (uiMapID: number): LuaArray<TaskPOIData> => {
        return {} as any;
    },
