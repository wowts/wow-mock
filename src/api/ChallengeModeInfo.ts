...
export const C_ChallengeMode = {
    ...
    SlotKeystone: (): void => {},
    StartChallengeMode: (): boolean => {return false},
};
export type ChallengeModeCompletedEvent = (frame: UIFrame, e: "CHALLENGE_MODE_COMPLETED") => void
export type ChallengeModeDeathCountUpdatedEvent = (frame: UIFrame, e: "CHALLENGE_MODE_DEATH_COUNT_UPDATED") => void
export type ChallengeModeKeystoneReceptableOpenEvent = (frame: UIFrame, e: "CHALLENGE_MODE_KEYSTONE_RECEPTABLE_OPEN") => void
export type ChallengeModeKeystoneSlottedEvent = (frame: UIFrame, e: "CHALLENGE_MODE_KEYSTONE_SLOTTED", keystoneID: number) => void
export type ChallengeModeLeadersUpdateEvent = (frame: UIFrame, e: "CHALLENGE_MODE_LEADERS_UPDATE") => void
export type ChallengeModeMapsUpdateEvent = (frame: UIFrame, e: "CHALLENGE_MODE_MAPS_UPDATE") => void
export type ChallengeModeMemberInfoUpdatedEvent = (frame: UIFrame, e: "CHALLENGE_MODE_MEMBER_INFO_UPDATED") => void
export type ChallengeModeResetEvent = (frame: UIFrame, e: "CHALLENGE_MODE_RESET", mapID: number) => void
export type ChallengeModeStartEvent = (frame: UIFrame, e: "CHALLENGE_MODE_START", mapID: number) => void